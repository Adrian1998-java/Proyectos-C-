...
using WebAPI_RECU_Customer_Invoice.Data;
using WebAPI_RECU_Customer_Invoice.Models;

namespace WebAPI_RECU_Customer_Invoice.Controllers
{
    public class InvoicesController : Controller
    {
        ...
        {
            var chinookContext = _context.Invoices.Include(i => i.Customer);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ChinookContext.Invoices'  is null.");
            }
            var invoice = await _context.Invoices.FindAsync(id);
            if (invoice != null)
            {
